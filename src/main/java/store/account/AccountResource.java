...
public class AccountResource implements AccountController {
    ...
    // Has the API endpoints of the Account microsservice, implementing the
    // AccountController interface defined in the account module, and using
    // the AccountService to handle the business logic of the API endpoints
